...
function OrderReconciliation({ tenantId }) {
  ...
  // "How much has actually reached me for this range, and how much is still
  // to come" - the two questions the order table could only answer by hand
  // before. Released is Amazon's own payment_received flag, so this is not an
  // estimate: it is the sum of payouts Amazon says it has released.
